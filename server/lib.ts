...
export function sanitizeClassification(raw: Record<string, unknown>): Record<string, unknown> {
...
export function extractNumericValue(entryType: string, value: Record<string, unknown>): number | null {
  ...
  switch (entryType) {
    ...
    case "sleep":
      return typeof value.duration_hours === "number" ? value.duration_hours : null;
    case "exercise":
